    ...
    , systemWSLabel(nullptr)
{
    ...
    ui->menuHelp->addAction(actionAuthor);
...
void MainWindow::createTrayIcon() {
    ...
    authorAction = new QAction(tr("作者主页"), this);
    authorAction->setIcon(QIcon(":/icons/github.png"));
...
QIcon MainWindow::createTextIcon(int usagePercent) {  // 移除结尾的const
